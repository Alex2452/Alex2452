...
<div id="content">
 ...
 <div id="image">
   <div id="sidebar1">
                 <H1 align="center">Edit Employee Account!</h1>
...
<tr bgcolor="#990000">
<th style='height:30px;		font-weight:bold;'><font color='white' size='2'>Emp_id</th>
<th style='height:30px;		font-weight:bold;'><font color='white' size='2'>Names</th>
<th style='height:30px;		font-weight:bold;'><font color='white' size='2'>Role</th>
<th style='height:30px;		font-weight:bold;'><font color='white' size='2'>Username</th>
<th style='height:30px;		font-weight:bold;'><font color='white' size='2'>Password</th>
<th style='height:30px;		font-weight:bold;'><font color='white' size='2'>Email</th>
<th style='height:30px;		font-weight:bold;'><font color='white' size='2'>Action</th>
...
<td><?php echo $row['email'];?></td>
						<?php
print("
		<td style='height:30px;'><a href = 'editaccount.php?emp_id=".$row['emp_id']."'>[Edit]</a></td>
		");?>
