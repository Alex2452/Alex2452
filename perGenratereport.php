...
<div id="content">
<div id="login">
        <center> <form action="education.php" method="post" >

        <center><input type="submit" name="submit" value="Based on Education level" /></center>
         </form><br />
          <form action="salery.php" method="post" >

        <center><input type="submit" name="submit" value="Based on salary" /></center>
         </form></center>
  </div>
                </div> 
