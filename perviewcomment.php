...
<script type="text/javascript">
  function isdelete()
  {
   ...
   if(!d)
   {
    alert(window.location='perviewcomment.php');
   }
   else
   {
   return false;
...
echo"<br><br><h2 align='center'>Message from Adminsterator</h2>";
echo "<table border='1' cellpadding='6' align='center' >
<tr >
<th bgcolor='#990000'>Message</th>
...
echo $new;
echo"</td>";
echo "<td >" ."<a href='deletemes.php ?del=$row[id]'><p onclick='isdelete();'>[Delete]</p></a> ". "</td>";
echo "</tr>";
}
echo "</table>";
mysql_close($con);
