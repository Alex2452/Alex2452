...
<script type="text/javascript">
  function isdelete()
  {
   ...
   if(!d)
   {
    alert(window.location='adminviewcomment.php');
   }
   else
   {
   return false;
...
$result = mysql_query("SELECT * FROM empcomment");
echo"<br><br><h2 align='center'>Message</h2>";
...
echo $new;
echo"</td>";
echo "<td >" ."<a href='empdeletecom.php ?del=$row[id]'><p onclick='isdelete();'>[Delete]</p></a> ". "</td>";
echo "</tr>";
}
echo "</table>";
...
?>	 
                  ...
                  <center><a href="adminmessage.php"><input name="" type="button" value="Message" /></a></center>
                </div> 
