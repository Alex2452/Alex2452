...
echo '<p style=color:#FF0000>You have not entered search details. Please go back and try again.<a href="Admisearch.php" style=text-decoration:none><input type="button" value="back"></a></p>';
exit;
}
...
print("
<td ><a href = 'updateempinfo.php?emp_id=".$row['emp_id']."'>[Edit]</a>
     <a href = 'resultss.php?emp_id=".$row['emp_id']."'><p onclick='isdelete();'>[Delete]</p></a></td>
		");
